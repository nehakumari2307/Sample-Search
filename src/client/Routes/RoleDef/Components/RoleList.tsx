...
import { RoleListProp } from '../Types/RoleListProp';
import { ROLE } from '../../../ThemeIdentifiers';
import { SearchStatus } from 'Common/Constants';
import { RolesByNameDesc } from '../Redux/RoleListReducer';
import appStore from 'Redux/Store';
    ...
    },
    {
      ...
      injectBody: (value: IRoleDef) => (
        <Badge
          ...
          status={
            AllowedEntityStatusColor[
              value.processing ? 8 : getBadgeStatus(value)
            ]
          }
        >
    ...
    return [
      {
        content: (
          <Checkbox
            ...
            onChange={(e: boolean) =>
              appStore.dispatch(
                RolesByNameDesc(this.state.filterConfig.searchKey, e)
              )
            }
          />
        )
      ...
      <FlexBox>
        <Column medium="4-4">
          ...
          <div className={theme.pageContainer}>
            ...
            >
              <div>
                <Button
                  ...
                  onClick={(event: React.FormEvent<HTMLElement>) =>
                    this.toggleDropdown(event, 'bulkAction')
                  }
              ...
              <div className={searchFieldStyle}>
                <TextField
                  ...
                  onChange={t => {
                    filterConfig.searchKey = t;
                    AppStore.dispatch(RolesByNameDesc(t));
                  }}
                />
              </div>
            ...
            {roleDefs ? (
              roleDefs.status === SearchStatus.SUCCESS ? (
                <Table
...
export default connect(
  null,
  (dispatch: Dispatch<string>, props: RoleListProp) => {
    return props;
  }
)(
  themr(ROLE, baseTheme)(RoleListComponent) as ThemedComponentClass<
    RoleListProp,
    RoleListState
  >
);
